...
* [The "United Nations" for regulatory agencies (RA)]{.rn-fragment rn-type=highlight}
...
* Each RA implements these as regulations
  ...
  * [FDA provides [a lot more documentation](https://www.fda.gov/industry/fda-data-standards-advisory-board/study-data-standards-resources){target="_blank"} than just the 21 CFR regulations]{.rn-fragment rn-type=underline rn-color=red}
...
**M11** [Clinical electronic Structured Harmonized Protocol (CeSHarP)]{.rn-fragment rn-type=highlight rn-color=green rn-multiline=true fragment-index=9}
...
* eCTD is a digital version of this (folder / file structure)
  * eCTD v4 is [just now accepted by FDA](https://intuitionlabs.ai/articles/ich-m8-ectd-v4-specification){target="_blank"}
* CSR is a clinical study report and is the contents of "m5"
  * Online books for how to do this in [R](https://r4csr.org){target="_blank"} and [Python](https://pycsr.org){target="_blank"}

## CDISC - `www.cdisc.org` {.smaller}

* [Global non-profit setting data standards for clinical trials]{.rn-fragment rn-type=highlight}
...
* [Different RAs have different rules on use of CDISC]{.rn-fragment rn-type=underline rn-color=red}
* [Even for FDA - CDER, CBER, and CDRH have different rules]{.rn-fragment rn-type=underline rn-color=red}
...
* Data flow
  * [raw/CRF]{.rn-fragment rn-type=highlight} &rarr; EDC &rarr; [SDTM data]{.rn-fragment rn-type=highlight} &rarr; [ADaM data]{.rn-fragment rn-type=highlight} &rarr; ARD &rarr; [TLFs for PDFs]{.rn-fragment rn-type=highlight}
...
* Learning Resources
  * Full [examples website](https://pharmaverse.github.io/examples/){target="_blank"} you can run on Posit Cloud or locally
  * See [Navitas webinar](https://www.youtube.com/watch?v=zYCOxWk9bYY){target="_blank"} for more on this
  * [30 days of pharmaverse](https://www.indraneelchakraborty.com/30-days-of-pharmaverse/){target="_blank"}

## Where we at? {.smaller}

* Submissions
  * [Pilots](https://r-consortium.org/posts/submissions-wg-2026/index.html){target="_blank"} - execute R, custom packages, `{shiny}` apps, `{renv}`, podman, WebAssembly, dataset-json
  * FDA regulatory changes on using `.zip` files for custom R packages
* Validation
  * Packages to collect risk metrics, publish to repos, generate docs, [R itself](https://www.r-project.org/doc/R-FDA.pdf){target="_blank"}
  * Meta-packages to track issues and generate docs - [`{qcchat}`](https://gilead-biostats.github.io/qcthat/){target="_blank"}
* ICH / FDA / CDISC work
...
![](./images/qr-code.png){width="200"}
:::

::: {.column width="40%"}

![](./images/sas-nicer-grave.png){width="400"}
:::
...
* Clinical Standards web - https://www.clinstandards.org
* PSI (Statisticians in the Pharmasceutical Industry) - https://www.psiweb.org
* TransCelerate - https://www.transceleratebiopharmainc.com
* BioCelerate   https://biocelerate.org
* Clinical Research Data Sharing Alliance - https://crdsalliance.org/
* OHDSI
* GA4GH
:::
